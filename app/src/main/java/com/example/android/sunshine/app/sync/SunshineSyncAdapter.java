    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if(forecastJson.has(OWM_MESSAGE_CODE)){
                //Find out Code that was returned to check location
                int cod = forecastJson.getInt(OWM_MESSAGE_CODE);
                switch(cod){
        ...
        if ( displayNotifications ) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    int iconWidth = Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB
                            ? resources.getDimensionPixelSize(android.R.dimen.notification_large_icon_width)
                            : resources.getDimensionPixelSize(R.dimen.notification_large_icon_default);

                    int iconheight = Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB
                    ...
                    try {
                        ...
                        e.printStackTrace();
                        Log.d(LOG_TAG, "Image not fetched from "+ artresourceurl +". Loading normal image");
